...
t_pCloudFrame pCloudFrame(std::shared_ptr<Kinect>& sptr_kinect)
{
    sptr_kinect->capture();
    ...
    t_pCloudFrame data = std::make_pair(frame, pCloud);
...
int main()
{
    ...
    while (!done) {
        t_pCloudFrame rgbdData = pCloudFrame(sptr_kinect);
