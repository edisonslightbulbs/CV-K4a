...
void findCorners(std::vector<cv::Mat>& images,
...
int main()
{
    ...
    read("calibration.txt", cameraMatrix, distanceCoefficients);
    find(cameraMatrix, distanceCoefficients, arucoSquareDimension);
